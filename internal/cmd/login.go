...
func init() {
	Login.Flags().Int("client-version-major", WhatsAppVerMajor, "WhatsApp Client major version. Can be override using WHATSAPP_CLIENT_VERSION_MAJOR environment variable")
	Login.Flags().Int("client-version-minor", WhatsAppVerMinor, "WhatsApp Client minor version. Can be override using WHATSAPP_CLIENT_VERSION_MINOR environment variable")
	Login.Flags().Int("client-version-build", WhatsAppVerBuild, "WhatsApp Client build version. Can be override using WHATSAPP_CLIENT_VERSION_BUILD environment variable")
